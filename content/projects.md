...
Tech: JavaScript SPA, iOS wrapper (Cordova/WebView), AdMob, Facebook Ads

Around 3,000 monthly active users.

![Text Wallpaper screenshot](/images/projects/text-wallpaper.png)
...
A web app for painting a 3D delivery robot.
