...
date = 2022-05-03
description = 'Embedding a web server inside a Flutter app to mock APIs when backend endpoints are not yet ready.'
aliases = ['/flutter-mock-api-server/']
+++

(Edit 23.05.2022) I gave a tech talk about this at Flutter Nordics Helsinki Meetup, you can watch it here:
